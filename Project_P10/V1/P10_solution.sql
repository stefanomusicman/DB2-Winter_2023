...
---------1
 ...
 CREATE USER miwa IDENTIFIED BY flash36;
 GRANT connect, resource TO miwa;
 connect miwa/flash36


--c##des02

SPOOL C:\Users\kakum\DB2\part10_q1_spool.txt
...
VALUES (10, 'Kaku', 'Miwa', 'E', to_date('04/09/1953', 'mm/dd/yyyy'), '1000 M Street, Apt. #10', 'Montreal', 'WI', 
...
SPOOL C:\Users\kakum\DB2\part10_q2_spool.txt
...
GRANT SELECT, INSERT, UPDATE , DELETE ON order_line TO miwa;
...
SPOOL C:\Users\kakum\DB2\part10_q3_spool.txt

SELECT to_char(sysdate,'DD Month Year Day HH:MI:SS Am') FROM dual;

CREATE TABLE order_line_row_audit (row_id NUMBER, 
         updating_user VARCHAR2(30), updating_time DATE,old_o_id NUMBER, old_inv_id NUMBER,
